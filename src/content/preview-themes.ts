...
export const PREVIEW_THEMES: PreviewThemeMeta[] = [
  ...
  },
  {
    id: "vercel",
    label: "Edge",
    subtitle: "Warm paper mono — Vercel-sharp neutrals.",
    dots: ["bg-amber-50", "bg-zinc-600", "bg-zinc-950"],
  },
  {
    id: "linear",
    label: "Triage",
    subtitle: "Lilac canvas, iris violet primary.",
    dots: ["bg-violet-200", "bg-violet-600", "bg-indigo-950"],
  },
  {
    id: "stripe",
    label: "Checkout",
    subtitle: "Cool paper, electric payments indigo.",
    dots: ["bg-slate-200", "bg-indigo-600", "bg-slate-950"],
  },
  {
    id: "github",
    label: "Primer",
    subtitle: "Blue-slate canvas, crisp Primer blue.",
    dots: ["bg-sky-100", "bg-blue-600", "bg-slate-900"],
  },
  {
    id: "supabase",
    label: "Postgres",

...
Optional: list the bundle on Gumroad at $0 only if you want email capture — many libraries host free samples on their own domain (Tailwind UI / marketing kits pattern).
